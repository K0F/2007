class Car {
  ...
  Car(Vector3D l, float ms, float mf) {
  ...
  void wander(float chng) {
    ...
    float wanderD = 55.0f;         // Distance for our "wander circle"
    ...
    circleloc.add(loc);               // Make it relative to Car's location
