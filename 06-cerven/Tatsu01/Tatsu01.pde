...
void setup(){
 ...
 noSmooth();
  ...
  for(int i = 0;i<bot.length;i++){
    bot[i] = new Bot(i,width/2,height/2,map(i,0,bot.length,1.001,3.001),map(i,0.0,bot.length,1.01,3.1));
...
void draw(){
 ...
 rect(0,0,width,height);
  ...
  for(int i = 0;i<bot.length;i++){
    bot[i].draw();
    if(i!=0){
      if(i%3==0){stroke(#FFAA22,15);}else if(i%2==0){stroke(#aa0505,15);}else if(i%5==0){stroke(#330505,15);}
