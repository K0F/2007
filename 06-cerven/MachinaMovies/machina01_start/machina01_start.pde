...
void setup(){
 ...
 frameRate(25);
  background(255);
  println(sketchPath);
  movie = new MovieMaker(this, width, height, "vids/temp.mov",MovieMaker.JPEG,MovieMaker.HIGH,25) ;
  frame.setTitle("machina001");
  datos=loadStrings(sketchPath+"/machina01_start.pde");
  ...
  // lexiGram=loadImage("hieroglyphs.gif");t
...
//  movie(31f,56f,128);
  ...
  /* 
    ...
    */
    noStroke();
    fill(cols[2],map(POSUVNIK,width,0,0,85));
